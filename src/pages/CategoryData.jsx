  ...
  return (
    ...
    <div className="details text-dark container">
          <ul className="ps-2 m-0 d-flex gap-2 py-2 align-items-center">
            ...
            <li className="align-items-center">
              ...
              <span className="fs-6 text-capitalize">School Benches</span>{" "}
              <i class="bi bi-arrow-right-short "></i>{" "}
            </li>
          </ul>
        </div>
    <section className="popular-content pb-4">
        <div className="container shadow p-3">
            ...
            <h4 className="text-uppercase m-0 p-0 fs-5 pt-2">School Benches</h4>
            
          <hr />
          <div className="row">
            {Fdata.slice(17, 29).map((item) => (
              <div className="col-lg-2 col-sm-6 col-md-3  py-4 hidden-icon">
                <Link to={`/details/${item.id}`}>
                  <div className="card my-2 mx-1 bg-light">
